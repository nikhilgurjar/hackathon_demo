...
import { background, grey } from "../palette";
...
const MuiDataGrid = {
  ...
  defaultProps: {
    slots: {
      ...
      columnSortedAscendingIcon: (props) => (
        <DataGridArrowUpIcon sx={{ color: grey[200] }} {...props} />
      ),
      columnSortedDescendingIcon: (props) => (
        <DataGridArrowDownIcon sx={{ color: grey[200] }} {...props} />
      ),
      ...
      columnMenuIcon: (props) => (
        <DataGridMoreIcon sx={{ color: "#fff" }} width={20} {...props} />
      ),
      ...
      columnFilteredIcon: (props) => (
        <DataGridFilterIcon sx={{ width: 16, color: grey[200] }} {...props} />
      ),
      /* Density */
      ...
      quickFilterIcon: (props) => (
        <DataGridSearchIcon
          sx={{ width: 24, height: 24, color: grey[200] }}
          {...props}
        />
      ),
  ...
  styleOverrides: {
    root: ({ theme }) => ({
      ...
      "--DataGrid-rowBorderColor": theme.vars.palette.grey[200],
    ...
    columnHeader: ({ theme }) => ({
      ...
      background: theme.vars.palette.background.tableHeader,
      "&--sorted": { color: theme.vars.palette.grey[300] },
    }),
