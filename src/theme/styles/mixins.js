...
import { remToPx, mediaQueries, varAlpha } from "./utils";
...
export function paper({ theme, color, dropdown }) {
  return {
    ...
    backgroundImage: `url(${process.env.PUBLIC_URL}/assets/cyan-blur.png), url(${process.env.PUBLIC_URL}/assets/red-blur.png)`,
